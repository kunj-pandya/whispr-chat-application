...
const Login = () => {
    ...
    return <>
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white">
                    ...
                    <form
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="email"
                                    className="w-full border-gray-300 rounded-md py-2 pl-10 pr-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            {/*--------------S RIGHT SIDE - PATTERN ------------- */}

            <AuthImagePattern title={"Welcome Back!"} subtitle={"Sign in to continue your conversataion and catch up with your messages."} />
        </div>
    </>;
};
