...
const Navbar = () => {
    ...
    return <>
        <header className="fixed top-0 w-full bg-white/80 backdrop-blur-lg border-1 border-gray-200 shadow-sm">
                    ...
                    <div className="flex items-center gap-3">
                        {
                            authUser && (
                                <>
                                    <Link to={"/profile"}
                                        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium text-gary-700 hover:bg-gray-100 transition"
                                    >
